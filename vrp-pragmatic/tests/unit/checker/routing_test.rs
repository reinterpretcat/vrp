...
fn create_test_solution(statistic: Statistic, stop_data: &[(Timestamp, i64); 3]) -> Solution {
...
fn can_check_stop_impl(stop_data: &[(Timestamp, i64); 3], expected_result: Result<(), Vec<GenericError>>) {
