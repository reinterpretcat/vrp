...
[![dependency status](https://deps.rs/crate/vrp-cli/1.11.3/status.svg)](https://deps.rs/crate/vrp-cli/1.11.3)
...
```bash
    docker run -it -v $(pwd):/repo --name vrp-cli --rm ghcr.io/reinterpretcat/vrp/vrp-cli:1.11.3
```
