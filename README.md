...
[![dependency status](https://deps.rs/crate/vrp-cli/1.10.6/status.svg)](https://deps.rs/crate/vrp-cli/1.10.6)
...
```bash
    docker run -it -v $(pwd):/repo --name vrp-cli --rm ghcr.io/reinterpretcat/vrp/vrp-cli:1.10.6
```
