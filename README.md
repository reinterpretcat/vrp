...
[![dependency status](https://deps.rs/crate/vrp-cli/1.15.0/status.svg)](https://deps.rs/crate/vrp-cli/1.15.0)
...
```bash
    docker run -it -v $(pwd):/repo --name vrp-cli --rm ghcr.io/reinterpretcat/vrp/vrp-cli:1.15.0
```
