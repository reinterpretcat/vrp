...
* [Concepts](concepts/index.md)
  * [Pragmatic format](concepts/pragmatic/index.md)
    * [Modeling a problem](concepts/pragmatic/problem/index.md)
      * [Simple jobs](concepts/pragmatic/problem/simple-jobs.md)
      * [Multi jobs](concepts/pragmatic/problem/multi-jobs.md)
      * [Vehicle types](concepts/pragmatic/problem/vehicle-types.md)
      * [Relations](concepts/pragmatic/problem/relations.md)
    * [Routing matrix](concepts/pragmatic/routing/index.md)
