...
parameterized_test! {can_insert_service_with_two_vehicles_and_various_time_constraints, (job_location, v1_end_location, v2_end_location, expected_used_vehicle, cost), {
    can_insert_service_with_two_vehicles_and_various_time_constraints_impl(job_location, v1_end_location, v2_end_location, expected_used_vehicle, cost);
}}

can_insert_service_with_two_vehicles_and_various_time_constraints! {
    case1: (3, Some(0), Some(20), "v1", (3.0 + 3.0) * 2.0),
    case2: (27, Some(0), Some(20), "v2", (7.0 + 7.0) * 2.0),
    case3: (11, Some(12), Some(20), "v1", (12.0 + 12.0)),
}

fn can_insert_service_with_two_vehicles_and_various_time_constraints_impl(
