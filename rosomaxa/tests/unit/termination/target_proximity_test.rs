...
can_use_target_proximity! {
    case01: (vec![vec![0.5, 0.5]], 0., 0.1, false),
    case02: (vec![vec![0., 0.]], 0.89, 0.1, false),
    case03: (vec![vec![0., 0.]], 0.91, 0.1, true),
}
...
fn can_use_target_proximity_impl(
    ...
    let result = TargetProximity::new(target_fitness, distance_threshold).is_termination(&mut context);
