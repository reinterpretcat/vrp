...
mod node_growing {
    ...
    can_grow_initial_nodes_properly! {
        case01: ((0, 0), vec![((-1, 0), vec![-6.905, 4.968, 13.873]), ((0, -1), vec![0.018, 2.991, 6.954])]),
        case02: ((0, 1), vec![((-1, 0), vec![1.011, 2.0, 10.905]), ((0, 1), vec![2.991, 5.963, 9.927])]),
        case03: ((1, 0), vec![((1, 0), vec![16.863, 2.0, -3.945]), ((0, -1), vec![14.863, -1.958, -2.947])]),
        case04: ((1, 1), vec![((1, 0), vec![3.982, 10.918, 4.973]), ((0, 1), vec![-2.947, 12.884, 11.894])]),
    }
    ...
    fn can_grow_new_nodes_properly() {
        ...
        [
            ((2, 2), vec![2.987, 3.974, 12.856]),
            ((0, 2), vec![2.979, 3.957, 12.766]),
            ((1, 3), vec![2.982, 3.964, 12.803]),
        ]
        .into_iter()
