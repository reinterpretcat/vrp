...
fn can_use_sequence_and_flexible_relation_for_one_vehicle() {
    ...
    let matrix = Matrix {
        ...
        num_destinations: 8,
        travel_times: vec![
            0, 1, 2, 3, 4, 5, 6, 1, 1, 0, 1, 2, 3, 4, 5, 2, 2, 1, 0, 1, 2, 3, 4, 3, 3, 2, 1, 0, 1, 2, 3, 4, 4, 3, 2, 1,
            0, 1, 2, 5, 5, 4, 3, 2, 1, 0, 1, 6, 6, 5, 4, 3, 2, 1, 0, 7, 1, 2, 3, 4, 5, 6, 7, 0,
        ],
        distances: vec![
            0, 1, 2, 3, 4, 5, 6, 1, 1, 0, 1, 2, 3, 4, 5, 2, 2, 1, 0, 1, 2, 3, 4, 3, 3, 2, 1, 0, 1, 2, 3, 4, 4, 3, 2, 1,
            0, 1, 2, 5, 5, 4, 3, 2, 1, 0, 1, 6, 6, 5, 4, 3, 2, 1, 0, 7, 1, 2, 3, 4, 5, 6, 7, 0,
...
fn can_use_sequence_and_flexible_relation_for_two_vehicles() {
    ...
    let matrix = Matrix {
        ...
        num_destinations: 9,
        travel_times: vec![
            0, 1, 2, 3, 4, 5, 6, 7, 1, 1, 0, 1, 2, 3, 4, 5, 6, 2, 2, 1, 0, 1, 2, 3, 4, 5, 3, 3, 2, 1, 0, 1, 2, 3, 4, 4,
            4, 3, 2, 1, 0, 1, 2, 3, 5, 5, 4, 3, 2, 1, 0, 1, 2, 6, 6, 5, 4, 3, 2, 1, 0, 1, 7, 7, 6, 5, 4, 3, 2, 1, 0, 8,
            1, 2, 3, 4, 5, 6, 7, 8, 0,
        ],
        distances: vec![
            0, 1, 2, 3, 4, 5, 6, 7, 1, 1, 0, 1, 2, 3, 4, 5, 6, 2, 2, 1, 0, 1, 2, 3, 4, 5, 3, 3, 2, 1, 0, 1, 2, 3, 4, 4,
